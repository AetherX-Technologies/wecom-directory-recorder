...
class RapidVideOCR:
    def __init__(self, input_params: RapidVideOCRInput):
        ...
        self.ocr_processor = OCRProcessor(
            input_params.ocr_params,
            input_params.batch_size,
            input_params.ocr_client,
        )
...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Schedule remote OCR by batches. Each image is still sent separately. Default is False.",
    )
    parser.add_argument(
        "-b",
        "--batch_size",
        type=int,
        default=10,
        help="The number of images in each remote OCR scheduling batch. Default is 10.",
    )
